...
if [ "$point" = "1" ]; then
curl -s -o ip.txt https://raw.githubusercontent.com/Septahadif/Proxy-Finder/main/ipv4.txt
elif [ "$point" = "2" ]; then
curl -s -o ip.txt https://raw.githubusercontent.com/Septahadif/Proxy-Finder/main/ipv6.txt
else
